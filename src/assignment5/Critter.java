    ...
    protected String look(int direction, boolean steps) {
		...
		switch (direction){
			case 0: // 0: (1,0) 
				...
				if(worldMap[xWrap(x_coord,1)][y_coord] != null) {
